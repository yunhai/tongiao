<?php
/**
 * ChucviectinhdocusiphathoivietnamFixture
 *
 */
class ChucviectinhdocusiphathoivietnamFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'chucviectinhdocusiphathoivietnam';
