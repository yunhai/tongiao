...
////////////////////////////////////////////////////////////
	...
	public function upload($source, $targetdir, $targetfile) {
		...
		if(($filesize < MIN_SIZE_IMG) || ($filesize > MAX_SIZE_IMG)) {
			return 'Image filesize must be between ' . $this->human_filesize(MIN_SIZE_IMG) . ' and ' . $this->human_filesize(MAX_SIZE_IMG);
		}
