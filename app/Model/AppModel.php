...
class AppModel extends Model {
    ...
    public function convertDataSave($data) {
        ...
        if (isset($data[$alias]['trinhdohocvan'])) {
            ...
            unset($trinhdohocvan['trinhdohocvan_totnghieptruong'][0]);
            unset($trinhdohocvan['trinhdohocvan_nam'][0]);
        ...
        if (isset($data[$alias]['trinhdothanhoc'])) {
            ...
            unset($trinhdothanhoc['trinhdothanhoc_totnghieptruong'][0]);
            unset($trinhdothanhoc['trinhdothanhoc_nam'][0]);
        ...
        if (isset($data[$alias]['trinhdongoaingu'])) {
            ...
            unset($trinhdongoaingu['trinhdongoaingu_totnghieptruong'][0]);
            unset($trinhdongoaingu['trinhdongoaingu_nam'][0]);
        ...
        if (isset($data[$alias]['trinhdotinhoc'])) {
            ...
            unset($trinhdotinhoc['trinhdotinhoc_totnghieptruong'][0]);
            unset($trinhdotinhoc['trinhdotinhoc_nam'][0]);
        ...
        if (isset($data[$alias]['anhchiemruot'])) {
            ...
            unset($anhchiemruot['anhchiemruot_quanhe'][0]);
            unset($anhchiemruot['anhchiemruot_hoten'][0]);
            unset($anhchiemruot['anhchiemruot_namsinh'][0]);
            unset($anhchiemruot['anhchiemruot_nguyenquan'][0]);
        ...
        if (isset($data[$alias]['anhchiemvochong'])) {
            ...
            unset($anhchiemvochong['anhchiemvochong_quanhe'][0]);
            unset($anhchiemvochong['anhchiemvochong_hoten'][0]);
            unset($anhchiemvochong['anhchiemvochong_namsinh'][0]);
            unset($anhchiemvochong['anhchiemvochong_nguyenquan'][0]);
        ...
        if (isset($data[$alias]['vochongvacon'])) {
            ...
            unset($vochongvacon['vochongvacon_quanhe'][0]);
            unset($vochongvacon['vochongvacon_hoten'][0]);
            unset($vochongvacon['vochongvacon_namsinh'][0]);
            unset($vochongvacon['vochongvacon_nguyenquan'][0]);
        ...
        if (isset($data[$alias]['quatrinhhoatdongtongiaootrongnuoc'])) {
            ...
            unset($quatrinhhoatdongtongiaootrongnuoc['qthdtqtn_tungaythangnam'][0]);
            unset($quatrinhhoatdongtongiaootrongnuoc['qthdtqtn_denngaythangnam'][0]);
            unset($quatrinhhoatdongtongiaootrongnuoc['qthdtqtn_noihoatdong'][0]);
            unset($quatrinhhoatdongtongiaootrongnuoc['qthdtqtn_chucvu'][0]);
        ...
        if (isset($data[$alias]['quatrinhhoatdongtongiaoongoainuoc'])) {
            ...
            unset($quatrinhhoatdongtongiaoongoainuoc['qthdtqnn_tungaythangnam'][0]);
            unset($quatrinhhoatdongtongiaoongoainuoc['qthdtqnn_denngaythangnam'][0]);
            unset($quatrinhhoatdongtongiaoongoainuoc['qthdtqnn_noidunghoatdong'][0]);
            unset($quatrinhhoatdongtongiaoongoainuoc['qthdtqnn_tennuocden'][0]);
