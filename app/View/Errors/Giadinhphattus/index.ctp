...
<div id="accordion" role="tablist" aria-multiselectable="true">
    <?php
    echo $this->Form->create('Giadinhphattu', array('inputDefaults' => array(
            'label' => false,
            'div' => false,
            'error' => false,
        ),
                    ...
                    <div id="collapse_<?php echo $key; ?>" class="panel-collapse collapse <?php echo $is_col; ?>" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            <div class="input-group col-xs-12 ">
                                ...
                                switch ($key) {
                                    case 0:
                                        echo $this->element("form/giadinhphattus/content_1", array("key" => $key));
                                        break;
                                    case 1:
                                        echo $this->element("form/giadinhphattus/content_2", array("key" => $key));
                                        break;
                                    case 2:
                                        echo $this->element("form/giadinhphattus/content_3", array("key" => $key));
                                        break;
                                    case 3:
