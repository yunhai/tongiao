...
<div id="accordion" role="tablist" aria-multiselectable="true">
    <?php
        echo $this->Form->create('Chucsaccaodai', array('inputDefaults' => array(
                'label' => false,
                'div' => false,
                'error' => false,
            ),
                        ...
                        <div class="panel-body">
                            <div class="input-group col-xs-12 ">
                                <?php
                                    switch ($key) {
                                        case 0:
                                            echo $this->element("form/Chucsaccaodais/content_1", array("key" => $key));
                                            break;
                                        case 1:
                                            echo $this->element("form/Chucsaccaodais/content_2", array("key" => $key));
                                            break;
                                        case 2:
