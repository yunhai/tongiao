...
<div class="row-fluid">
    ...
    <div class="span11 " style="margin-top: 10px; width: 95%;margin-left: 30px;">
        ...
        <p>
            <?php
            echo $this->Form->create('Chihoitinlanh', array('inputDefaults' => array(
                    'label' => false,
                    'div' => false,
                    'error' => false,
                ),
                "type" => "get",
                "class" => "form-inline",
                'url' => Router::url(array( 'controller' => 'Chihoitinlanhs', 'action' => 'index'), true)
            ));
            ?>
        ...
        <span class="text-right pull-right">
            <?php
            $url = Router::url(array( 'controller' => 'Chihoitinlanhs', 'action' => 'add'), true);
            echo $this->Html->link(
        ...
        <table class="table table-bordered" >
            <tbody>
                <tr>
                    <td class="aside aligncenter" style="width: 10%;" >Tên chi hội</td>
...
<!--                    <td class="aside aligncenter" style="width: 10%;">Ngày cấp</td>-->
                ...
                foreach ($data as $val) {
                    ...
                    <tr>
                        <td align="center"> 
                            <?php echo $val["Chihoitinlanh"]["tenchihoi"]; ?>
                        </td >
                        <td align="center"> 
                            <?php echo $val["Chihoitinlanh"]["sodienthoai"]; ?>
                        </td >
                        <td align="center"> 
                            <?php echo $val["Chihoitinlanh"]["tenchihoi_sogiaychungnhan"]; ?>
                        </td >
<!--                        <td align="center"> 
                            <?php echo $val["Chihoitinlanh"]["tenchihoi_sogiaychungnhan_ngaycap"]; ?>
                        </td >-->
                        <td align="center"> 
                            <?php echo $val["Chihoitinlanh"]["tenchihoi_sogiaychungnhan_coquancap"]; ?>
                        </td >
                        <td align="center"> 
                            <?php
                            echo $this->Form->button(
                                ...
                                'onclick' =>
                                'window.location.href =  \'' . Router::url(array('controller' => 'Chihoitinlanhs', 'action' => 'add', $val["Chihoitinlanh"]["id"]), true) . '\'; '
                            ));
                            ...
                            echo $this->Form->button(
                                ...
                                . '{window.location.href =  \'' . Router::url(array('controller' => 'Chihoitinlanhs', 'action' => 'delete', $val["Chihoitinlanh"]["id"], $page), true) . '\';} return false;'
                                    )
                            );
                            ?>
                        </td>
