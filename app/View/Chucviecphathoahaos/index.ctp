                        ...
                        <div class="panel-body">
                            <div class="input-group col-xs-12 ">
                                <?php
                                    switch ($key) {
                                        case 0:
                                            echo $this->element("form/Chucviecphathoahaos/content_1", array("key" => $key));
                                            break;
                                        case 1:
                                            echo $this->element("form/Chucviecphathoahaos/content_2", array("key" => $key));
                                            break;
                                        case 2:
                                            echo $this->element("form/Chucviecphathoahaos/content_cacthongtinkhac", array("key" => $key));
                                            break;
                                        case 3:
                                            echo $this->element("form/Chucviecphathoahaos/content_kiennghi", array("key" => $key));
                                            break;
                                        default:
                                            break;
                                    }
