            ...
            <tr>
                ...
                <th class="col-xs-2 text-left">
                    <label class="control-label pull-right">
                        <?php 
                            if ($key == "pbtsxptt_nambonhiem" || 
                                $key == "tbtsxptt_nambonhiem" || 
                                $key == "tvbddt_nambonhiem" || 
                ...
                <td >
                    <?php
                        if ($key == "Địa chỉ" || 
                            ...
                            echo $this->element("form/Chucviecphathoahaos/tb_children", array("data" => $val, "is_call" => 1));
                        } else if ($key == "Bố, mẹ đẻ") {
                            echo $this->element("form/Chucviecphathoahaos/tb_children_quanhe", array("data" => $val, "is_call" => 1));
