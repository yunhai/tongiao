            ...
            <tr>
                ...
                <th class="col-xs-2 text-left">
                    <label class="control-label pull-right">
                        <?php 
                            if ($key == "ntncpls_noicauphong" || 
                                $key == "ntndctgh_noicauphong" || 
                                $key == "ntndctgs_noicauphong" ||
                                $key == "ntndctps_noicauphong"
                            ) {
                                echo "Nơi cầu thăng";
                            } elseif ($key == "pbcq_nambonhiem" || 
                                $key == "cqdh_nambonhiem" || 
                ...
                <td >
                    <?php
                        if ($key == "Địa chỉ" || 
                            ...
                            echo $this->element("form/Chucsaccaodais/tb_children", array("data" => $val, "is_call" => 1));
                        } else if ($key == "Bố, mẹ đẻ") {
                            echo $this->element("form/Chucsaccaodais/tb_children_quanhe", array("data" => $val, "is_call" => 1));
