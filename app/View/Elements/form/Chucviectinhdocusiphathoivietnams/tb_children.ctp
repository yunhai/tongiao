            ...
            <tr>
                ...
                <th class="col-xs-2 text-left">
                    <label class="control-label pull-right">
                        <?php 
                            if ($key == "ntndbnttv_noibonhiem" || 
                                $key == "ntndbnpgs_noibonhiem" || 
                                $key == "ntndbnhs_noibonhiem"
                            ) {
                                echo "Nơi bổ nhiệm";
                            } elseif ($key == "pbytpt_nambonhiem" || 
                                $key == "tbytpt_nambonhiem" || 
                                $key == "tvbtsct_nambonhiem" || 
                                $key == "tvbtstu_nambonhiem"
                            ) {
                                echo "Năm bổ nhiệm";
                ...
                <td >
                    <?php
                        if ($key == "Địa chỉ" || 
                            ...
                            echo $this->element("form/Chucviectinhdocusiphathoivietnams/tb_children", array("data" => $val, "is_call" => 1));
                        } else if ($key == "Bố, mẹ đẻ") {
                            echo $this->element("form/Chucviectinhdocusiphathoivietnams/tb_children_quanhe", array("data" => $val, "is_call" => 1));
